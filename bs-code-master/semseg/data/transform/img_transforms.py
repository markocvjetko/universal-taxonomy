...
class ScaleToFit:
    ...
    def __call__(self, ret_dict):
        ret_dict['image'] = ret_dict['image'].resize((self.max_w, self.max_h), PIL.Image.BILINEAR)
        ret_dict['labels'] = ret_dict['labels'].resize((self.max_w, self.max_h), PIL.Image.NEAREST)
        return ret_dict
